...
async def create_database_pool():
    ...
    await bot.pg_con.execute("CREATE TABLE IF NOT EXISTS Events (id  SERIAL PRIMARY KEY, message_id bigint, calendar_id text, date_time timestamp with time zone, event_name text , event_link text, notified boolean);")
